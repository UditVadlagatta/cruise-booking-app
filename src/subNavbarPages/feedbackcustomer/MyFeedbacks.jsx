  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <div className="flex gap-3 md-10">
  ...
  return (
    <div className="space-y-4">
      ...
      {feedbacks.map((fb) => {
        ...
        return (
          <div key={fb._id}
            className="p-5 border border-gray-100 rounded-2xl bg-gray-50 hover:bg-white hover:shadow-md transition-all">
...
const Feedback = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-start justify-center py-10 px-4">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-xl border border-gray-100 overflow-hidden">

        {/* Header */}
        <div className="flex items-center gap-4 p-8 pb-6 border-b border-gray-100">
          <div className="text-3xl bg-blue-50 p-3 rounded-2xl">💬</div>
          <div>
            <h1 className="text-2xl font-bold text-gray-900 leading-tight">Feedback</h1>
        ...
        {/* Toggle */}
        <div className="flex gap-1 p-2 mx-8 mt-6 bg-gray-100 rounded-2xl">
          <button
